...
trade.tradeItems!.push(TradeFactory.getTradedMajorPlayer(
...
describe("TradeTracker.appendNewTrade/1", () => {
    ...
    it("should add all trade participants items even if more than 3-team trade", async () => {
        ...
        bigTrade.tradeItems!.push(TradeFactory.getTradedMajorPlayer(
            PlayerFactory.getPlayer("Jose Bautista"),
            bigTrade.creator,
            thirdTeam
        ));
        bigTrade.tradeItems!.push(TradeFactory.getTradedMajorPlayer(
            PlayerFactory.getPlayer("Max Sherzer"),
            fourthTeam,
            bigTrade.creator
        ));
