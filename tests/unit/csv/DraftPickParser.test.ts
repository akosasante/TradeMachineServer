...
describe("DraftPickParser", () => {
    ...
    const testTeam1 = TeamFactory.getTeam(undefined, undefined, { owners: [owner1] });
    const testTeam2 = TeamFactory.getTeam(undefined, undefined, { owners: [owner2] });
    const testTeam3 = TeamFactory.getTeam(undefined, undefined, { owners: [owner3, owner4] });
