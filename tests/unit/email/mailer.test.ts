...
describe("EMAILER Class", () => {
    ...
    describe("email snapshots", () => {
        ...
        it("sendTestEmail", async () => {
            ...
            if (!email) { throw new Error("sendTestEmail returned undefined")}
        ...
        it("sendRegistrationEmail", async () => {
            ...
            if (!email) { throw new Error("sendRegistrationEmail returned undefined")}
            const { message, messageId, ...res } = email;
            expect(res).toMatchSnapshot();
        });
        ...
        it("sendPasswordResetEmail", async () => {
            ...
            if (!email) { throw new Error("sendPasswordResetEmail returned undefined")}
            const { message, messageId, ...res } = email;
            expect(res).toMatchSnapshot();
        });
        ...
        it("sendTradeRequestEmail", async () => {
            ...
            if (!email) { throw new Error("sendTradeRequestEmail returned undefined")}
            const { message, messageId, ...res } = email;
            expect(res).toMatchSnapshot();
        });
        ...
        it("sendTradeSubmissionEmail", async () => {
            ...
            if (!email) { throw new Error("sendTradeSubmissionEmail returned undefined")}
            const { message, messageId, ...res } = email;
            expect(res).toMatchSnapshot();
        });
        ...
        it("sendTradeDeclinedEmail", async () => {
            ...
            if (!email) { throw new Error("sendTradeDeclinedEmail returned undefined")}
            const { message, messageId, ...res } = email;
            expect(res).toMatchSnapshot();
        });
    });
