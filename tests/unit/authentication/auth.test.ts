...
describe("Authorization helper methods", () => {
    ...
    describe("signUpAuthentication", () => {
        ...
        it("should create and return a new user if none existed before", async () => {
            mockUserDAO.findUserWithPassword.mockReturnValueOnce(undefined);
            mockUserDAO.createUsers.mockReturnValueOnce([testUser]);
    ...
    describe("signInAuthentication", () => {
        ...
        it("should return an updated user if the password is matching", async () => {
            ...
            mockUserDAO.findUserWithPassword.mockReturnValueOnce(testsUserWithHashedPassword);
            mockUserDAO.getUserById.mockReturnValueOnce(testsUserWithHashedPassword);
            mockUserDAO.updateUser.mockReturnValueOnce(cleanedUser);
        ...
        it("should return an error if the password is not matching", async () => {
            mockUserDAO.findUserWithPassword.mockReturnValueOnce(testUser);
            mockUserDAO.getUserById.mockReturnValueOnce(
    ...
    describe("authorizationChecker", () => {
        ...
        it("should return true if the user is an admin no matter what", async () => {
            ...
            mockUserDAO.getUserById.mockReturnValueOnce(adminUser);
