...
describe("Trade Participant Class", () => {
    ...
    const participant = new TradeParticipant({participantType: TradeParticipantType.RECIPIENT, trade, team});
    ...
    describe("instance methods", () => {
        it("toString/0", () => {
            expect(participant.toString()).toMatch("for trade#");
            expect(participant.toString()).toMatch("and team#");
        });
    });
});
