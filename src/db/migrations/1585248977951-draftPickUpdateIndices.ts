...
export class draftPickUpdateIndices1585248977951 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "IDX_71715a4e4ab6bea1e8167d85c3"`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "IDX_71715a4e4ab6bea1e8167d85c5"`, undefined);
