...
export class tradeUpdates1585510875614 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_cbff369d9b0f3e749d8895fbbb"`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_cbff369d9b0f3e749d8895fbbc"`, undefined);
