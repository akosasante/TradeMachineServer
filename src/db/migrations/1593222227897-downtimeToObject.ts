...
DROP INDEX "dev"."IDX_40e3ad1d41d05dda60e9ba76ee"`, undefined);
        await queryRunner.query(`-- noinspection SqlResolve

ALTER TABLE "dev"."settings" DROP COLUMN "downtimeStartDate", DROP COLUMN "downtimeEndDate", DROP COLUMN "downtimeReason"`, undefined);
...
DROP INDEX "dev"."IDX_40e3ad1d41d05dda60e1aa77ee"`, undefined);
        await queryRunner.query(`-- noinspection SqlResolve

DROP INDEX "dev"."IDX_40e3ad1d41d05dda60e9ba77ee"`, undefined);
...
CREATE INDEX "IDX_40e3ad1d41d05dda60e9ba76ee" ON "dev"."settings" ("downtimeStartDate", "downtimeEndDate", "downtimeReason", "modifiedById") `, undefined);
    }
