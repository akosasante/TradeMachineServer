...
ALTER TABLE "dev"."settings" DROP CONSTRAINT "FK_edbfdecf43bec56ee160c9ba6ac"`);
        await queryRunner.query(`-- noinspection SqlResolve

ALTER TABLE "dev"."user" DROP CONSTRAINT "FK_edbfdecf43bec56ee160c9ba6bd"`);
        await queryRunner.query(`-- noinspection SqlResolve

DROP INDEX "dev"."IDX_40e3ad1d41d05dda60e9zZba22dd"`);
        await queryRunner.query(`-- noinspection SqlResolve

DROP INDEX "dev"."IDX_945a167cdde65d4fb6bf5508d9f75584"`);
        await queryRunner.query(`-- noinspection SqlResolve

DROP INDEX "dev"."IDX_cbff369d9b0f3e749d8895fbbc"`);
        await queryRunner.query(`-- noinspection SqlResolve

DROP INDEX "dev"."IDX_40e3ad1d41d05dda60e9ba77ee"`);
        await queryRunner.query(`-- noinspection SqlResolve

DROP INDEX "dev"."IDX_40e3ad1d41d05dda60e1aa77ee"`);
        await queryRunner.query(`-- noinspection SqlResolve

DROP INDEX "dev"."IDX_40e3ad1d41d05dda60e9ba76de"`);
        await queryRunner.query(`-- noinspection SqlResolve

DROP INDEX "dev"."IDX_71715a4e4ab6bea1e8167d84c5"`);
...
CREATE INDEX "IDX_9612a91c314e8c1914ba0388ed" ON "dev"."settings" ("downtimeStartDate", "downtimeEndDate", "downtimeReason", "modifiedById") `);
...
ALTER TABLE "dev"."draft_pick" DROP CONSTRAINT "UQ_b0ee29a2eed55b5c4739873e3cd"`);
        await queryRunner.query(`-- noinspection SqlResolve

ALTER TABLE "dev"."player" DROP CONSTRAINT "UQ_b3fd08fd2ba540e6fc2b6946e2c"`);
        await queryRunner.query(`-- noinspection SqlResolve
...
ALTER TABLE "dev"."team" DROP CONSTRAINT "UQ_4f8b73a54933f9eab5177b90362"`);
...
DROP TABLE "dev"."scheduled_downtime"`);
...
ALTER TABLE "dev"."user" ADD CONSTRAINT "FK_edbfdecf43bec56ee160c9ba6bd" FOREIGN KEY ("teamId", "currentOwnerId") REFERENCES "dev"."team"("id","id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
